...
window.onload = function () {
    ...
    function preload() {
        ...
        //Load images
        game.load.image('platform', 'asset/platform_1.png');
        game.load.image('platform2', 'asset/platform_2.png');

        //Load spritesheets
        game.load.spritesheet('player', 'asset/chalkers.png', 48, 62);
        game.load.spritesheet('coin', 'asset/coin.png', 36, 44);
        game.load.spritesheet('badge', 'asset/badge.png', 42, 54);
        game.load.spritesheet('poison', 'asset/poison.png', 32, 32);
        game.load.spritesheet('star', 'asset/star.png', 32, 32);
    }
